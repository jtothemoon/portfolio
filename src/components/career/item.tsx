    ...
    <>
      ...
      {jobs.map((job, index) => (
        <div key={index} className='mb-4'>
          ...
          <time className='text-sm font-sans leading-none text-neutral-800 dark:text-neutral-200'>
            {job.start} — {job.end}
          </time>
          <ul className='mt-1 dark:text-neutral-400 text-neutral-600 text-pretty font-sans'>
